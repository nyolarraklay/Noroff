...
function Venues({ venue, isBooked, venueManager }) {
  ...
  return (
        ...
        <div className="bg-blue-400 p-1 rounded-md border border-gray-200 shadow-md  grid lg:grid-cols-6 grid-rows-1 gap-4">
        ...
        <div className=" xs:col-span-3">
          <div className="flex flex-col justify-between h-full py-5 " >
            ...
            {venueManager ? (<button><Link to={`/edit-venue/${venue.id}/${venueManager}`}>Edit</Link></button> ) : (<div className="flex justify-start ">
