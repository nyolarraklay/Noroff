...
function VenueManagerSignUp() {
  ...
  return (
   ...
   <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
             ...
             <div>
                        ...
                        <div className="mt-1">
                            ...
                            <label className="inline-flex items-center ml-6">
                                <input type="radio" className="form-radio" name="isVenueManager" value="false" onChange={handleVenueManagerChange} />
    ...
    <p className='text-center text-sm mt-3 font-bold'> <Link to={"/log-in/venue-manager"}>Already have an account? Log-In</Link> </p>
</div>
